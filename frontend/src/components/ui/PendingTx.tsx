...
const TX_LABELS: Record<PendingTxType, string> = {
  ...
  pay_usad: 'Processing USAD payment',
  ...
  buy_sale_usad: 'Purchasing with USAD',
  complete_sale_escrow: 'Completing sale (ALEO)',
  complete_sale_usdcx: 'Completing sale (USDCx)',
  complete_sale_usad: 'Completing sale (USAD)',
  cancel_sale: 'Cancelling sale',
  refund_sale_escrow: 'Refunding sale (ALEO)',
  refund_sale_usdcx: 'Refunding sale (USDCx)',
  refund_sale_usad: 'Refunding sale (USAD)',
};
